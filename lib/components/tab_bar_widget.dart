...
import 'package:recipeapps/constans/constant_function.dart';
import 'package:recipeapps/screens/detail_screen.dart';
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  SizedBox(height: h*.01,),
                  Text("calories: ${calories.toString()} . ${time.toString()} Min", style: TextStyle(fontSize: w*.03, color: Colors.grey))
                ],
              )
            ],
         ),
